package com.yao.springbootweixin.itchat4j.utils;
...
public class MyHttpClient {
	...
	public HttpEntity doGet(String url, List<BasicNameValuePair> params, boolean redirect,
		...
		try {
			...
			httpGet.setHeader("User-Agent", com.yao.springbootweixin.itchat4j.utils.Config.USER_AGENT);
			if (headerMap != null) {
	...
	public HttpEntity doPost(String url, String paramsStr) {
		...
		try {
			...
			httpPost.setHeader("User-Agent", com.yao.springbootweixin.itchat4j.utils.Config.USER_AGENT);
