package com.yao.springbootweixin.itchat4j.utils.tools;
...
public class DownloadTools {
	...
	private static com.yao.springbootweixin.itchat4j.utils.MyHttpClient myHttpClient = core.getMyHttpClient();
	...
	public static Object getDownloadFn(BaseMsg msg, String type, String path) {
		...
		String url = "";
		if (type.equals(com.yao.springbootweixin.itchat4j.utils.enums.MsgTypeEnum.PIC.getType())) {
			url = String.format(URLEnum.WEB_WX_GET_MSG_IMG.getUrl(), (String) core.getLoginInfo().get("url"));
		} else if (type.equals(com.yao.springbootweixin.itchat4j.utils.enums.MsgTypeEnum.VOICE.getType())) {
			url = String.format(URLEnum.WEB_WX_GET_VOICE.getUrl(), (String) core.getLoginInfo().get("url"));
		} else if (type.equals(com.yao.springbootweixin.itchat4j.utils.enums.MsgTypeEnum.VIEDO.getType())) {
			headerMap.put("Range", "bytes=0-");
			url = String.format(URLEnum.WEB_WX_GET_VIEDO.getUrl(), (String) core.getLoginInfo().get("url"));
		} else if (type.equals(com.yao.springbootweixin.itchat4j.utils.enums.MsgTypeEnum.MEDIA.getType())) {
			headerMap.put("Range", "bytes=0-");
