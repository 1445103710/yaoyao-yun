package com.yao.springbootweixin.itchat4j.face;
...
import com.yao.springbootweixin.itchat4j.core.Core;
...
public class MsgHandlerFaceImpl implements IMsgHandlerFace{
    ...
    public String picMsgHandle(BaseMsg msg) {
        ...
        String picPath = qrPath+"/pic" + File.separator + fileName + ".jpg"; // 调用此方法来保存图片
    ...
    public String voiceMsgHandle(BaseMsg msg) {
        ...
        String voicePath = qrPath+"/voice" + File.separator + fileName + ".mp3";
