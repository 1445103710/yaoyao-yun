package com.yao.springbootweixin.itchat4j.core;
...
import com.yao.springbootweixin.itchat4j.utils.enums.MsgCodeEnum;
...
public class MsgCenter {
	 ...
	 * @param msgHandler
	 */
	public static void handleMsg(com.yao.springbootweixin.itchat4j.face.IMsgHandlerFace msgHandler) {
		while (true) {
					...
					if (msg.getType() != null) {
						try {
							if (msg.getType().equals(MsgTypeEnum.TEXT.getType())) {
								...
								com.yao.springbootweixin.itchat4j.api.MessageTools.sendMsgById(result, core.getMsgList().get(0).getFromUserName());
								...
								com.yao.springbootweixin.itchat4j.api.MessageTools.sendMsgById(result,
