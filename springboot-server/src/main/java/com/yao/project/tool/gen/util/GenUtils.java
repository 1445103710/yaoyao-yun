package com.yao.project.tool.gen.util;

import com.yao.common.constant.CommonMap;
...
{
    /** 项目空间路径 */
    private static final String projectPath = "main/java/com/yao/project";
    ...
    public static void main(String[] args)
    {
        ...
        System.out.println(getModuleName("com.yao.project.system"));
    }
}
