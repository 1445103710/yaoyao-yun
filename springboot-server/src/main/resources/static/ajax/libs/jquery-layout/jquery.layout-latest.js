...
,	isMouseOverElem: function (evt, el) {
	 ...
	 * @example $.layout.msg({ foo: "bar" }, "Title");	// log hash-data, with user title
...
,	inset:						null		// user container-inset values (override padding)
...
,	north: {
	...
	,	resizerCursor:			"n-resize"	// user = url(myCursor.cur)
...
,	sizeMidPanes = function (panes, skipCallback, force) {
	...
	/**
	 * @see  window.onresize(), callbacks or user code
...
;	// END var DECLARATIONS
	...
	function keyDown (evt) {
		...
		if (CURSOR && options[PANE[code]].enableCursorHotkey) // valid cursor-hotkey
			pane = PANE[code];
		else if (CTRL || SHIFT) // check to see if this matches a user-hotkey
...
,	bind: function (inst, sel, action, pane) {
	...
	/**
	* Add a user Toggler button for a pane
	*
	* @param {(string|!Object)}	selector	jQuery selector (or element) for button, eg: ".ui-layout-north .toggle-button"
	* @param {string}  			pane 		Name of the pane the button is for: 'north', 'south', etc.
...
,	addToggle: function (inst, selector, pane, slide) {
	...
	/**
	* Add a user Open button for a pane
	*
	* @param {(string|!Object)}	selector	jQuery selector (or element) for button, eg: ".ui-layout-north .toggle-button"
	* @param {string}			pane 		Name of the pane the button is for: 'north', 'south', etc.
	* @param {boolean=}			slide 		true = slide-open, false = pin-open
...
,	addOpen: function (inst, selector, pane, slide) {
	...
	/**
	* Add a user Close button for a pane
	*
	* @param {(string|!Object)}	selector	jQuery selector (or element) for button, eg: ".ui-layout-north .toggle-button"
	* @param {string}   		pane 		Name of the pane the button is for: 'north', 'south', etc.
	*/
,	addClose: function (inst, selector, pane) {
	...
	/**
	* Add a user Pin button for a pane
	*
